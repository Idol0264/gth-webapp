/* =========================================================
   ...
   Automatically detects the current GTH platform/page.
...
(() => {
  ...
  /*
   * GTH homepage:
   * Put effects behind both the initial
   * welcome gate and the main home hero.
   */
  if (platform === "gth") {
    const gate =
  ...
  /*
   * GTF / GTC / GTS:
   * Put effects behind the main hero.
   */
  const hero =
...
/* =========================================================
   Create normal platform effect field
   ========================================================= */

function addEffectTarget(
  target,
  config
) {
  if (
